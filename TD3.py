...
class TD3(object):
  ...
  def train(self, replay_buffer, iterations, batch_size=256, discount=0.99, tau=0.005, policy_noise=0.2, noise_clip=0.5, policy_freq=2):  ## batch size modified by Nouran
...
max_timesteps = 1e5 # Total number of iterations/timesteps  ## Modified by Nouran
save_models = True # Boolean checker whether or not to save the pre-trained model
expl_noise = 0.1 # Exploration noise - STD value of exploration Gaussian noise
batch_size = 256 # Size of the batch ## Modified by Nouran
