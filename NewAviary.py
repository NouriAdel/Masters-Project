...
class NewAviary(BaseSingleAgentAviary):
    ...
    def _computeDone(self):
        ...
        """
        if self._check_pos_out(0):
            print("pos out", self._check_pos_out)
            return True 
        if self._check_angles_out(0):
    ...
    def _computeObs(self):
        ...
        if self.OBS_TYPE == ObservationType.RGB:
            ...
            pos_error = obs[0:3] - self.desired_pos[0:3]
    ...
    def reset(self):
        ...
        #self.INIT_XYZS = self._generate_init_pos()[0]
