...
from gym_pybullet_drones.envs.multi_agent_rl.NewLeaderAviary import NewLeaderAviary  ##Nouran
...
if __name__ == "__main__":
    ...
    if OBS == ObservationType.KIN:
        OWN_OBS_VEC_SIZE = 15   ##Nouran modified 12 to be 15
    ...
    elif ARGS.exp.split("-")[1] == 'newleader':  ##Nouran
        register_env(temp_env_name, lambda _: NewLeaderAviary(num_drones=NUM_DRONES,
                                                           aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                                                           obs=OBS,
                                                           act=ACT
                                                           )
    ...
    if ARGS.exp.split("-")[1] == 'flock':
        ...
        temp_env = NewLeaderAviary(num_drones=NUM_DRONES,
                                aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                                obs=OBS,
                                act=ACT
                                )
    ...
    #config = ppo.DEFAULT_CONFIG.copy() # For the default config, see github.com/ray-project/ray/blob/master/rllib/agents/trainer.py  ##Modify
    config = ddpg.DEFAULT_CONFIG.copy()  ##Nouran
    config = {
        "env": temp_env_name,
    ...
    #### Restore agent #########################################
    #agent = ppo.PPOTrainer(config=config)  ##Modify
    agent = ddpg.TD3Trainer(config=config)  ##Nouran
    #with open(ARGS.exp+'/checkpoint.txt', 'r+') as f:
        #checkpoint = f.read()
        #print("hi, ", checkpoint)
        #print("hi, ", type(checkpoint))
    #checkpoint = "/home/nouri/gym-pybullet-drones/experiments/learning/results/save-newleader-2-cc-kin-rpm-01.24.2022_19.32.42/TD3/TD3_this-aviary-v0_685b1_00000_0_2022-01-24_19-32-46/checkpoint_000111/checkpoint-111"
    #checkpoint = "/home/nouri/gym-pybullet-drones/experiments/learning/results/save-leaderfollower-2-cc-kin-one_d_rpm-01.25.2022_17.05.58/TD3/TD3_this-aviary-v0_4f0b9_00000_0_2022-01-25_17-06-01/checkpoint_000092/checkpoint-92"
    #checkpoint = "/home/nouri/gym-pybullet-drones/experiments/learning/results/save-newleader-2-cc-kin-rpm-02.12.2022_10.59.40/TD3/TD3_this-aviary-v0_e8bde_00000_0_2022-02-12_10-59-54/checkpoint_002942/checkpoint-2942"
    checkpoint = "/home/nouri/gym-pybullet-drones/experiments/learning/results/save-newleader-2-cc-kin-rpm-03.04.2022_22.50.27/TD3/TD3_this-aviary-v0_7e74c_00000_0_2022-03-04_22-50-31/checkpoint_001975/checkpoint-1975"
    ...
    if ARGS.exp.split("-")[1] == 'flock':
        ...
        test_env = NewLeaderAviary(num_drones=NUM_DRONES,
                                aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                                obs=OBS,
                                act=ACT,
                                gui=True,
