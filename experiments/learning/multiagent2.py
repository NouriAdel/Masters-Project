...
if __name__ == "__main__":
    ...
    #filename = os.path.dirname(os.path.abspath(__file__))+'/results/save-newleader-2-cc-kin-rpm-02.28.2022_07.38.47'
    ...
    print("hii", torch.cuda.device_count())
    ...
    stop = {
        "timesteps_total": 2000000, # 100000 ~= 10'  ##Nouran was 120000
    ...
    print("hi",torch.cuda.is_available())
    #ray.init(num_gpus=1)
    ...
    print("Best trial config: {}".format(trial.config))
    #print("Best trial final validation loss: {}".format(
        #trial.last_result["loss"]))
    #print("Best trial final validation accuracy: {}".format(
        #trial.last_result["accuracy"]))
    print("Best trial final validation episode mean reward: {}".format(
