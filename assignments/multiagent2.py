...
sys.path.append('/content/drive/MyDrive/gym-pybullet-drones')

import gym_pybullet_drones
from gym_pybullet_drones import *

sys.path.append('/content/drive/MyDrive/gym-pybullet-drones/gym_pybullet_drones/envs')
import BaseAviary

sys.path.append('/content/drive/MyDrive/gym-pybullet-drones/gym_pybullet_drones/envs/single_agent_rl')
import BaseSingleAgentAviary

sys.path.append('/content/drive/MyDrive/gym-pybullet-drones/gym_pybullet_drones/envs/multi_agent_rl')
import BaseMultiagentAviary
import NewLeaderAviary

sys.path.append('/content/drive/MyDrive/gym-pybullet-drones/experiments/learning')
import multiagent2
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env',         default='leaderfollower',  type=str,             choices=['leaderfollower', 'flock', 'meetup' , 'newleader'],      help='Task (default: leaderfollower)', metavar='')
    ...
    if ARGS.obs==ObservationType.KIN:
        OWN_OBS_VEC_SIZE = 15 ##Nouran modified from 12 to 15
    ...
    elif ARGS.env == 'newleader':  ##Nouran
        register_env(temp_env_name, lambda _: NewLeaderAviary(num_drones=ARGS.num_drones,
                                                           aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                                                           obs=ARGS.obs,
                                                           act=ARGS.act
                                                           )
    ...
    if ARGS.env == 'flock':
        ...
        temp_env = NewLeaderAviary(num_drones=ARGS.num_drones,
                                aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                                obs=ARGS.obs,
                                act=ARGS.act
                                )
    ...
    stop = {
        "timesteps_total": 120000, # 100000 ~= 10'  ##Nouran was 120000
